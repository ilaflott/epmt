...
#         pass
    ...
    def test_job_proc_tags(self):
        ...
        # #     self.assertEqual(md5(str(tags)).hexdigest(), '7083bed0954830e2daa34a1113209177', 'wrong hash of tags')
