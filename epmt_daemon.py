...
def daemon_loop(context, niters = 0, post_process = True, analyze = True, retire = False, ingest = False, recursive = False, keep = False, verbose = 0):
    ...
    with context:
        ...
        if hasattr(context, 'detach_process') and context.detach_process == True:
        ...
        while (True):
            ...
            if post_process:
                ...
                from epmt_query import get_unprocessed_jobs, post_process_jobs
                ...
                if analyze:
                    from epmt_query import analyze_jobs
