...
class EPMTSubmit(unittest.TestCase):
    ...
    def test_convert_csv(self):
        ...
        for k in job_dict_csv.keys():
            if k in {'updated_at', 'created_at', 'rdtsc_duration'}: continue
